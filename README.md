...
> | :--- | :--- | :--- | :--- |
> | 💾 **Windows Installer** | [**`DiskCleanUp-Setup-2.2.0-x64.exe`**](https://github.com/103PU/disk-cleaner/releases/download/v2.2.0/DiskCleanUp-Setup-2.2.0-x64.exe) | ~13 MB | **Recommended.** Automated wizard, Desktop & Start Menu shortcuts |
> | 📦 **Portable Edition** | [**`DiskCleanUp-v2.2.0-windows-x64-portable.zip`**](https://github.com/103PU/disk-cleaner/releases/download/v2.2.0/DiskCleanUp-v2.2.0-windows-x64-portable.zip) | ~16 MB | Standalone folder, no install needed. Extract all & run |
> | 🔒 **Checksums** | [**`SHA256SUMS.txt`**](https://github.com/103PU/disk-cleaner/releases/download/v2.2.0/SHA256SUMS.txt) | <1 KB | SHA-256 integrity verification |
...
- [**`DiskCleanUp-Setup-2.2.0-x64.exe`**](https://github.com/103PU/disk-cleaner/releases/download/v2.2.0/DiskCleanUp-Setup-2.2.0-x64.exe)
...
- [**`DiskCleanUp-v2.2.0-windows-x64-portable.zip`**](https://github.com/103PU/disk-cleaner/releases/download/v2.2.0/DiskCleanUp-v2.2.0-windows-x64-portable.zip)
...
- `dist/DiskCleanUp-Setup-2.2.0-x64.exe` (Windows Installer, ~13 MB)
